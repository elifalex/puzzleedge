...
interface MiniSudokuCategoryCardProps {
...
export function MiniSudokuCategoryCard({
  difficulty,
  totalPuzzles,
  completedCount,
  isExpanded,
        ...
        <Animated.View style={[styles.expandedContent, { maxHeight }]}>
          ...
          <View style={styles.puzzleGrid}>
            {Array.from({ length: totalPuzzles }, (_, i) => {
              const puzzleId = `miniSudoku-${difficulty}-${String(i + 1000 + (difficulty === 'easy' ? 0 : difficulty === 'medium' ? 1000 : 2000)).padStart(4, '0')}`;
